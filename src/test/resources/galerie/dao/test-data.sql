...
INSERT INTO transaction (id, prix_vente, vendu_le,client_id,lieu_de_vente_id,oeuvre_id) VALUES (1,1000000, TO_DATE('01/06/2021', 'DD/MM/YYYY'), 1,1,1);
INSERT INTO transaction (id, prix_vente, vendu_le,client_id,lieu_de_vente_id,oeuvre_id) VALUES (2,1, TO_DATE('01/06/2021', 'DD/MM/YYYY'), 1,1,2);
